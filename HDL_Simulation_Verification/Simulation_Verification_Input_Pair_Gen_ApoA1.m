...
if GEN_PAIRWISE_FORCE_VALUE == 1
    ...
    for ref_particle_ptr = 1:home_cell_particle_num
        ...
        fprintf(fresult, '***Reference particle %d%d%d%2X: (%.3f,%.3f,%.3f), # of partner particles is %d, accumulated partial force is %tX.\n\n',HOME_CELL_X,HOME_CELL_Y,HOME_CELL_Z,ref_particle_ptr,ref_pos_x,ref_pos_y,ref_pos_z, cell_particle(home_cell_id,ref_particle_ptr,8), cell_particle(home_cell_id,ref_particle_ptr,4:6));
    end
    % Cloes file
    fclose(fresult);
