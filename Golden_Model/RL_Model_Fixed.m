...
%% All data in Matlab fixed point type (ufi datatype)
%% The binary point is keep shifting at different stage of evaluation
%% Dependency:
%%                      none
%%
%%
...
%     position_data(i,3) = ufi(raw_position_data(i,3), 32, 25);
% end

%% Load the pre-processed data in ufi type (7.25 format)
input_file_path = strcat(common_path, 'ufi_position_data.mat');
fprintf('*** Start reading data from input file %s ***\n', input_file_path);
